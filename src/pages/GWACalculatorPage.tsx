...
export default function GWACalculatorPage({ history }: GWACalculatorPageProps) {
    ...
    const clearAllModalRef = useRef<HTMLDialogElement>(null);
    ...
    const openClearAllModal = () => {
        clearAllModalRef.current?.showModal();
    };
    ...
    return (
        <>
            ...
            <dialog ref={clearAllModalRef} className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg text-error">Clear All Subjects?</h3>
                    <p className="py-4">
                        Are you sure you want to delete all {subjects.length} subjects? This action cannot be undone.
                    </p>
                    <div className="modal-action">
                        <button className="btn btn-ghost" onClick={() => clearAllModalRef.current?.close()}>
                            Cancel
                        </button>
                        <button className="btn btn-error" onClick={confirmClearAll}>
                            Yes, Clear All
                        </button>
                    </div>
                </div>
                ...
                <div className="ring ring-inset ring-base-300 rounded-md p-6 lg:p-10">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {subjects.length > 0 && (
                                <button className="btn btn-error btn-outline btn-sm" onClick={openClearAllModal}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
